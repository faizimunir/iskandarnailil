...
window.WEDDING_CONFIG = {
  ...
  weddingTime: '07:00',
  weddingTimeEnd: '10:00',
  weddingDay: 'Minggu',

  // Lokasi
  venue: 'Auditorium Masjid',
  address: 'Jalan Raya Bojongsari No.5, Gunung Putri, Citeureup, Bogor, Jawa Barat',
  mapUrl: 'https://maps.google.com/?q=Jalan+Raya+Bojongsari+No.5+Gunung+Putri+Citeureup+Bogor',
  ...
  instagramGroom: 'https://www.instagram.com/',
  streamingUrl: ''
};
